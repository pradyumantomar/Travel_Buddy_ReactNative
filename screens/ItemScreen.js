...
const ItemScreen = ({ route }) => {
  ...
  return (
    <SafeAreaView className="mt-8 flex-1 bg-white relative">
        ...
        <View className="relative bg-white shadow-lg">
          ...
          <View className="absolute flex-row inset-x-0 bottom-5 justify-between px-6">
            <View className="flex-row space-x-2 items-center">
              <Text className="text-[25px] font-bold text-[#13ff62]">
                {data?.price_level}
              </Text>
              <Text className="text-[32px] font-bold text-[#13ff62]">
                {data?.price}
              </Text>
            </View>
        ...
        <View className="mt-4 flex-row items-center justify-between">
          {data?.rating && (
            <View className=" flex-row items-center space-x-2">
              ...
              <View>
                <Text className="text-[#0c0c0c]">{data?.rating}</Text>
                <Text className="text-[#000000]">Ratings</Text>
              </View>
            </View>
          )}
          ...
          {data?.price_level && (
            <View className=" flex-row items-center space-x-2">
              ...
              <View>
                <Text className="text-[#0c0c0c]">{data?.price_level}</Text>
                <Text className="text-[#080808]">Price Level</Text>
              </View>
            </View>
          )}
